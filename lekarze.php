...
<body>
        <nav>
            <ul class="sidebar">
                ...
                <li><a href="#wizyty">Umów wizyte</a></li>
                <li><a href="#doctors">Lekarze</a></li>
                <li><a href="#medicine">Lekarstwa</a></li>
                <li><a href="#receipt">E-recepta</a></li>
                <li><a href="#question">Zapytaj lekarza</a></li>
                <li><a href="#services">Usługi</a></li>
                <li><a href="#contact">Contact</a></li>
            </ul>
            <ul>
                <li><a href="test.php">Home</a></li>
                <li class="hideOnMobile"><a href="loginPage.php">Konto</a></li>
                <li class="hideOnMobile"><a href="#wizyty">Umów wizyte</a></li>
                <li class="hideOnMobile"><a href="#doctors">Lekarze</a></li>
                <li class="hideOnMobile"><a href="#medicine">Lekarstwa</a></li>
                <li class="hideOnMobile"><a href="#receipt">E-recepta</a></li>
                <li class="hideOnMobile"><a href="#question">Zapytaj lekarza</a></li>
                <li class="hideOnMobile"><a href="#services">Usługi</a></li>
                <li class="hideOnMobile"><a href="#contact">Contact</a></li>
                <li class="hideOnMobile"><a href="adminPanel.php">Dla lekrza</a></li>
                <li onclick=showSidebar() class="menuBtn"><a href="#"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M120-240v-80h720v80>120Zm0-200v-80h720v80H120Zm0-200v-80h720v80H120Z"/></svg></a></li>
            </ul>
        </nav>
        <div class="container">
